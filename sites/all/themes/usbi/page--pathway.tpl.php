...
<div class="usbi-wrapper">
	<div id="usbi-path">    	
        <ul class="nav usbi-pathway ">
            ...
            <li class="patwaytiga"><a href="#path-3"><span>Earn a US-Accredited degree</span>Right here in Jakarta</a></li>
      ...
      <div id="path-0"> <?php $node_mom = node_load(139); print $node_mom->body['und'][0]['safe_value']; ?> </div>
